...
Feature: User create Material Purchase Bill Cheque
...
#		Then User Click Purchase Bill type field and select "Material Purchase Bill" 
...
#		
#	Scenario: Verify Data of Material Purchase Bill Cheque

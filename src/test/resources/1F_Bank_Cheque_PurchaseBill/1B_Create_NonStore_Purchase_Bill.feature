...
Feature: User create Non-Store Purchase Bill Cheque
	...
	Scenario: User Fillup Vendor & Amount Selection section
			...
			Then User Click Purchase Bill type field and select "Non-Store Purchase Bill" 
		...
		Scenario: Verify Data of Non-Store Purchase Bill Cheque
		...
		Scenario: Approve Non-Store Purchase Bill Cheque

...
Feature: User create Insurance Payment Cheque	
	Scenario: User going create Cheque page
			...
			Then User Click LC Payment type field and select "Insurance Payment"
			Then User Click Vendor List field and select "Gazipur Polish Store" 
			Then User Click Insurance Payment SL field and search "80"
			#Then User enters "1" in first row TDS field in LC Insurance Payment
			Then User enters "5" in first row Amount field LC Insurance Paymebt

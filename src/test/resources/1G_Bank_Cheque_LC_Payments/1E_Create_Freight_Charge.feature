...
Feature: User create Freight Charge Cheque	
	Scenario: User going create Cheque page
			...
			Then User Click Type field and select "Freight Charge"
			Then User Click Vendor List field and select "Gazipur Polish Store" 
			Then User Click Freight Charge NO field and search "74"
			#Then User enters "1" in first row TDS field in LC Arranger Commission
			Then User enters "5" in first row Amount field LC Freight Charge

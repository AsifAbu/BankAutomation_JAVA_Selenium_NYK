...
Feature: User create Transport Bill Cheque	
	Scenario: User going create Cheque page
			...
			Then User Click LC Payment type field and select "Transport Bill"
			Then User Click Vendor List field and select "Gazipur Polish Store" 
			Then User Click Transport Bill SL field and search "80"
			#Then User enters "1" in first row TDS field in LC Transport Bill
			Then User enters "5" in first row Amount field LC Transport Bill
